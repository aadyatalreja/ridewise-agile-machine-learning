...
st.set_page_config(page_title="DeepRideWise: DL Analysis", layout="centered")
...
def compare_models_view(X_train, X_test, y_train, y_test):
    ...
    # Fix: Return to Main Page button
...
def main():
    ...
    if st.session_state.page == "compare_models":
        ...
        st.markdown('<div class="gradient-text">DeepRideWise: Deep Learning for Bike Trip Classification</div>', unsafe_allow_html=True)
